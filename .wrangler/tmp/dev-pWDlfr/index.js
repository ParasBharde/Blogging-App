...
// .wrangler/tmp/bundle-KrkhtM/checked-fetch.js
...
`), { clientVersion: t.clientVersion });
    ...
    function Xl(e, t) {
      ...
      r && r instanceof z2 && ((n = r.getField("include")) == null || n.markAsError(), (i = r.getField("select")) == null || i.markAsError()), t.addErrorMessage((o) => `Please ${o.bold("either")} use ${o.green("`include`")} or ${o.green("`select`")}, but ${o.red("not both")} at the same time.`);
    }
    function ec(e, t) {
      var s, a;
...
Note that ${u.bold("include")} statements only accept relation fields.`, l;
    ...
    function nc(e, t) {
      ...
      n instanceof z2 && ((i = n.getField(r)) == null || i.markAsError(), pc(n, e.arguments)), t.addErrorMessage((o) => Ps(o, r, e.arguments.map((s) => s.name)));
    }
    function ic(e, t) {
      var o;
      ...
      if (i instanceof z2) {
        ...
        s instanceof z2 && Cs(s, e.inputType);
      }
    ...
    function sc(e, t) {
      ...
      n instanceof z2 && ((i = n.getDeepFieldValue(e.argumentPath)) == null || i.markAsError()), t.addErrorMessage((o) => {
    ...
    function lc(e, t) {
      ...
      if (n instanceof z2) {
        ...
        i instanceof z2 && Cs(i, e.inputType);
      }
      t.addErrorMessage((i) => {
  ...
  "node_modules/.prisma/client/edge.js"(exports) {
    ...
    var config = {
      "generator": {
        ...
        "output": {
          "value": "D:\\My_Work\\Full Stack Application\\hono-boilerplate\\node_modules\\@prisma\\client",
          "fromEnvVar": null
        },
        "config": {
          "engineType": "library"
...
// .wrangler/tmp/bundle-KrkhtM/middleware-loader.entry.ts
init_checked_fetch();
init_modules_watch_stub();

// .wrangler/tmp/bundle-KrkhtM/middleware-insertion-facade.js
init_checked_fetch();
init_modules_watch_stub();
...
var blogs_default = blogApp;

// src/routes/index.ts
var app2 = new Hono2();
app2.get("/user ", (context) => {
  return context.text("Hello User");
});
app2.route("/user", user_default);
app2.route("/blogs", blogs_default);
...
app3.route("/api/v1", routes_default);
